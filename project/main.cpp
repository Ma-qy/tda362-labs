...
//// Camera parameters.
/////////////////////////////////////////////////////////////////////////////////
//glm::vec3 cameraPosition(0.3, 0.35, 0.15);
////vec3 cameraPosition(0.0f, 0.0f, 3.0f);
//glm::vec3 cameraDirection = -normalize(cameraPosition - vec3(0.0f)); //从原点指向相机
//float cameraSpeed = 1.f;
//
//
//vec3 worldUp(0.0f, 1.0f, 0.0f);
//
//glm::vec3 cameraRight = glm::normalize(cross(cameraDirection, worldUp));
...
//Fluid3d::RenderWidget* renderer = nullptr;
//
///*
//struct Particle {
...
//
//
//std::vector<Particle> initParticleData(int numParticles) {
...
//
//		p.position = glm::vec4(pos * 10.0f, 1.0);
...
//}
//
//GLuint createParticleBuffer(const std::vector<Particle>& particles) {
//	GLuint particle_vao;
...
//{
//	Fluid3d::ParticleSystem ps;
//	glm::vec3 fluidLocation = glm::vec3(0.35f, 0.05f, 0.15f) + 2.0f * cameraDirection;
//	
//
//	
//	ps.SetContainerSize(fluidLocation, glm::vec3(0.6, 0.6, 0.6));
//	ps.AddFluidBlock(fluidLocation, glm::vec3(0.15, 0.15, 0.3), glm::vec3(0.0, -3.0, 0.0), 0.005 * 0.8);
//
//	//ps.AddFluidBlock(glm::vec3(0.35, 0.05, 0.25), glm::vec3(0.15, 0.15, 0.3), glm::vec3(0.0, -3.0, 0.0), 0.005 * 0.8);
//	ps.UpdateData();
...
//	fighterModelMatrix = translate(vec3(-5.0f, 15.0f, 0.0f));
...
//	
//	renderer = new Fluid3d::RenderWidget();
//	renderer->Init();
...
//	// setup matrices
//	///////////////////////////////////////////////////////////////////////////
//	mat4 projMatrix = perspective(radians(60.0f), float(windowWidth) / float(windowHeight), Para3d::zNear, Para3d::zFar);
//	//mat4 viewMatrix = lookAt(cameraPosition, cameraPosition + cameraDirection, worldUp);
//	mat4 viewMatrix = lookAt(cameraPosition, cameraPosition + cameraDirection, cameraUp);
//
